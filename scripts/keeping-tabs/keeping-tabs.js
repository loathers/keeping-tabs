  ...
  kmail: options => {
    ...
    return {
      ...
      finalize: () => {
        ...
        if (sumNumbers(actions_toConsumableArray(itemQuantities.values())) > 0) Kmail.send(target, (_options$body = options.body) !== null && _options$body !== void 0 ? _options$body : "", itemQuantities);
      }
    };
  },
  closet: options => {
